...
class send:
    ...
    def createClient(self, cliente):
        try:
            ...
            DataManipulator.insert(f"INSERT INTO clientes (idcliente,nombre,descuento,idtipodescuento,pais,curp,tipofacturacion,nocobrarimpuestos,tipocredito,idtipocliente,idtipomenu,contacto,telefono1,telefono2,telefono3,telefono4,telefono5,retenerimpuesto,tipocuenta,tipoclientencf ,descuentoprimeraventacomedoremp,contemplarpropina,status) VALUES ('{cliente['cedula']}','{cliente['nombre']}',0.000000,'{descuento}','URUGUAY','{cliente['cedula']}',1.000000,0,1.000000,'','', '{cliente['nombre']}', '', '','', '','',0,1.000000,0.000000,0.000000,0,1)")
